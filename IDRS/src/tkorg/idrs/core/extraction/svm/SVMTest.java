...
public class SVMTest {
	...
	public String run(String inputTestFile, String modelFile, String resultOutput) throws IOException
	{
		...
		try 
		{
			...
			String message = predict(input,output,model,predict_probability);
			input.close();
			output.close();
			return message;
		} 
