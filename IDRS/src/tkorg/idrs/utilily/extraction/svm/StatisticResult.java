 ...
 * @comment : 
 */
package tkorg.idrs.utilily.extraction.svm;
...
public class StatisticResult {
	...
	public String returnResultBy (int label) {
		...
		return "Summer "+ labelString +" line predict correct : " + totalCorrectLineByLabel + "/" + totalLineByLabel + " (" + (double)totalCorrectLineByLabel / totalLineByLabel * 100 + "%)";
	}
